...
class Version20160714164623 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE TiltagDetail ADD komponent_id INT DEFAULT NULL, DROP arealAfBeholderM2, DROP tankVolL');
        ...
        $this->addSql('ALTER TABLE TiltagDetail_audit ADD komponent_id INT DEFAULT NULL, DROP arealAfBeholderM2, DROP tankVolL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE TiltagDetail ADD arealAfBeholderM2 DOUBLE PRECISION DEFAULT NULL, ADD tankVolL NUMERIC(10, 4) DEFAULT NULL, DROP komponent_id');
        $this->addSql('ALTER TABLE TiltagDetail_audit ADD arealAfBeholderM2 DOUBLE PRECISION DEFAULT NULL, ADD tankVolL NUMERIC(10, 4) DEFAULT NULL, DROP komponent_id');
    }
}
