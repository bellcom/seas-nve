...
class Version20190806131800 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Virksomhed (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, cvr_number VARCHAR(255) NOT NULL, ean_numbers TINYTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', p_numbers TINYTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', crm_number VARCHAR(255) NOT NULL, branch_code VARCHAR(255) NOT NULL, contact_person VARCHAR(255) NOT NULL, customer_number VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, subsidy_level NUMERIC(10, 4) DEFAULT NULL, kalkulationsrente NUMERIC(10, 4) DEFAULT NULL, inflation NUMERIC(10, 4) DEFAULT NULL, lobetid NUMERIC(10, 4) DEFAULT NULL, env_p_number VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
