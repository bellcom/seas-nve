...
class BygningRapportExporter
{
    ...
    public function data(Rapport $rapport)
    {
        $data = array();
    ...
    public function cover2(Rapport $rapport, $review = FALSE)
    {
        $virksomhed = $rapport->getBygning()->getVirksomhed();
        ...
        return $this->renderView('AppBundle:Rapport:showExport2Cover.html.twig', $coverParams);
    }

    public function rapport2(Rapport $rapport, $review = FALSE)
    {
        return $this->renderView('AppBundle:Rapport:showExport2.html.twig', array(
            'rapport' => $rapport,
            'review' => $review,
    ...
    {
        $html = $this->cover2($rapport, TRUE);
        $html .= $this->rapport2($rapport, TRUE);
        return $html;
    }
