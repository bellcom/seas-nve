 ...
 * @Route("/elofordeling")
 */
class ELOFordelingController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('elofordeling_show', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('elofordeling_edit', array('id' => $id)));
        }
